...
<figure class="szene">
  <iframe src="/stuhleck-3d.html?v=14" title="Stuhleck summit in 3D: orthophoto on the laser-scan terrain with the Yagi stack on rotator 1, the quad stack on rotator 2, the car, the Steinbachalmbahn top station and the no-go sector towards the chairlift" loading="lazy" allowfullscreen></iframe>
