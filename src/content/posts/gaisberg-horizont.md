...
## Vier Standorte nebeneinander

Weil die Frage immer wieder auftaucht, hier die vier gerechneten Plätze mit **derselben Anlage**, die auch am Stuhleck geplant ist: ein Stack aus zwei 12-Element-Yagis (17,8 dBi, 34° Öffnung) und ein Stack aus zwei Vierfachquads (14,5 dBi, 69°), jeder auf drei Rotorstellungen, und 1 000 Watt auf beide zugleich — also **500 Watt je Stack**, so wie es auch am Stuhleck geplant ist. Erreichbar heißt hier nicht nur „Horizont frei", sondern auch: genug Gewinn für die Entfernung — 6 dBi bis 300 Kilometer, danach 3 dB je weitere hundert, bezogen auf ein Kilowatt. Der SRTM-Horizont und die Contestlogs sind für alle vier dieselben.

![Vergleich von vier Standorten mit derselben Anlage: waagrechte Balken der erreichbaren Stationen nach Ländern für Gaisberg 827, Feuerkogelhaus 945, Grünberg 1 015 und Traisner Hütte 1 015, daneben je eine Sektorrose mit den freien Richtungen und der Grundstellung des Yagi-Stacks](../../assets/karten/vier-standorte.png)
...
Vier Plätze, vier Charaktere — und mit der Leistung verschiebt sich das Bild noch einmal. Fünfhundert Watt je Stack sind drei Dezibel weniger als ein Kilowatt auf einer Antenne; die weiten Verbindungen fallen als Erste heraus, der Nahbereich bleibt.

Der **Grünberg** und die **Traisner Hütte** erreichen mit 1 015 gleich viele Stationen, aber völlig verschiedene: Die Traisner Hütte lebt vom Osten — Polen, Tschechien, die Slowakei —, der Grünberg von Deutschland und vom Nahbereich, wo er mit 861 Stationen unter 500 Kilometern (388 davon deutsche) alle anderen schlägt. Das **Feuerkogelhaus** liegt dazwischen und ist der einzige Platz mit Dach, Bahn und Küche.

Und der **Gaisberg** erreicht insgesamt am wenigsten — aber **nach Deutschland am meisten**: 506 deutsche Stationen, mehr als der Grünberg (473), das Feuerkogelhaus (407) und die Traisner Hütte (305). Sein sauberer Westsektor ist genau der, der zählt; die eigene Kuppe im Nordosten kostet ihn alles andere.

Auffällig ist, wie wenig die Höhe entscheidet: Der niedrigste Platz der vier, der Grünberg mit 989 Metern, holt im Nahbereich die meisten; der höchste, das Feuerkogelhaus mit 1 591, liegt im Mittelfeld. Es zählt, wohin der Horizont offen ist, nicht wie weit man hinaufgefahren ist.

Die Zahlen oben sind ohne Nahfeld gerechnet, also gutmütig. Am Gaisberg sind von den 1 112 Stationen mit freiem Fernhorizont nach dem Laserscan nur **803** wirklich frei — die eigene Kuppe kostet ein Viertel. Und dann kommen das Relais, der Sender und OE2M.
